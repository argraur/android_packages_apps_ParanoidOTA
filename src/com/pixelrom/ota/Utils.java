...
public class Utils {
    ...
    public static final String FILES_INFO = "com.pixelrom.ota.Utils.FILES_INFO";
    public static final String CHECK_DOWNLOADS_FINISHED = "com.pixelrom.ota.Utils.CHECK_DOWNLOADS_FINISHED";
    public static final String CHECK_DOWNLOADS_ID = "com.pixelrom.ota.Utils.CHECK_DOWNLOADS_ID";
    public static final String MOD_VERSION = "ro.modversion";
    public static final String RO_PA_VERSION = "ro.pixelrom.version";
